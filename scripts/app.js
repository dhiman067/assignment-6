                 ...
                 <h5 class="card-text">${modalInfo.description}</h5>
                        ...
                        <section class = "d-lg-flex gap-5">
                              ...
                              <div>
                                     <h5>Integrations</h5>
                                     <ul>
                                            <li>${modalInfo.integrations && modalInfo.integrations[0] ? modalInfo.integrations[0] : 'not available'} </li>
                                            <li>${modalInfo.integrations && modalInfo.integrations[1] ? modalInfo.integrations[1] : 'not available'}</li>
                                            <li>${modalInfo.integrations && modalInfo.integrations[2] ? modalInfo.integrations[2] : 'not available'}</li>
                                     </ul>
                              </div>
                        </section>
                  </div>
...
<div class="position-relative">
   <div class="position-absolute top-0 end-0 bg-danger text-white px-3 mt-3 me-3 rounded">${modalInfo.accuracy.score === null ? modalInfo.accuracy.score = ' ' :modalInfo.accuracy.score*100 + '% acccuracy'} </div>
   </div>
